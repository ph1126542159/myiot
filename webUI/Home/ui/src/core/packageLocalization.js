const packageTranslations = {
  'myiot.launcher': {
    zh: {
      name: '登录',
      title: '登录入口',
      description: 'MyIoT 的轻量登录入口，负责身份认证和首页跳转。',
    },
    en: {
      name: 'Login',
      title: 'Login Entry',
  ...
  'myiot.home': {
    zh: {
      name: '主页',
      title: '控制台主页',
      description: 'MyIoT 的主控制台页面，聚合导航、状态概览和诊断入口。',
    },
    en: {
      name: 'Home',
  ...
  'myiot.global-config': {
    zh: {
      name: '配置',
      title: '全局配置中心',
      description: '集中展示并修改当前系统的应用级配置和各功能包 Preferences 配置。',
    },
    en: {
      name: 'Config',
      title: 'Global Configuration Center',
      description: 'Review and edit application-wide properties together with per-bundle preferences.',
    },
  },
  ...
  'myiot.jndm123': {
    zh: {
      name: 'JNDM123',
      title: 'JNDM123 采集',
      description: '对 JNDM123 板上的 CDCE937 分频器和 6 颗 AD7606 采集通道进行网页化控制与实时可视化。',
    },
    en: {
      name: 'JNDM123',
